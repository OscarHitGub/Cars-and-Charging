...
def lp_map():
    data_openchargemap = requests.get("https://api.openchargemap.io/v3/poi/?output=json&countrycode=NL&maxresults=100&compact=true&verbose=false&key=5d087822-ce71-42b0-a231-67209f0900a2")
